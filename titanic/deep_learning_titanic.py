...
def preprocess_data():
    ...
    PROFILE_PATH = "./train_data_report.json"
...
def train(train_x, train_y):
    ...
    with tf.Session() as sess:
        with mlflow.start_run():
            with Trail("titanic") as run:
                run.put_hypothesis("deep-learning benchmark")
                run.put_artifact(PROFILE_PATH, "train data profiling result", "data")
